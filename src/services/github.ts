...
import { hasLixChanges } from "./utils.js";
...
${artifactHint}
  ...
  const footer = `---
<sub>Generated by [lix-diff-action](https://github.com/isabelroses/lix-diff-action) a fork of [nix-diff-action](https://github.com/natsukium/nix-diff-action) using [lix-diff](https://github.com/tgirlcloud/lix-diff)</sub>
...
export class GitHubService extends Effect.Service<GitHubService>()("GitHubService", {
  succeed: {
    ...
    postAggregatedComment: (
      ...
      Effect.gen(function* () {
        const hasChanges = results.some((r) => hasLixChanges(r.diff));
